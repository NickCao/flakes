  ...
  programs = {
    ...
    fish = {
      ...
      shellAbbrs = {
        ...
        armchair-rebuild = "nixos-rebuild -v -L --flake ~/Projects/flakes#armchair --target-host root@armchair.lan --build-host ssh-ng://root@armchair.lan --no-reexec";
        jetson-rebuild = "nixos-rebuild -v -L --flake ~/Projects/flakes#jetson --target-host root@jetson.lan --build-host ssh-ng://root@armchair.lan --no-reexec";
      };
    };
    tmux = {
      enable = true;
